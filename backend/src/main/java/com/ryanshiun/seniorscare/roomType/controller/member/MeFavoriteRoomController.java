...
@RestController
@RequestMapping("/api/room-types/member/favorites")
public class MeFavoriteRoomController {

    private final FavoriteRoomService service;

    public MeFavoriteRoomController(FavoriteRoomService service) {
